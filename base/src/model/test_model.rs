...
//         use $crate::unit::{UnitSettings, UnitSetting, UnitCategory, UnitKind, SimpleUnit, CompoundUnit, LengthUnit};
...
//         pub enum MockUnitCategory { 
//             #[default] 
//             Generic 
//         }

//         // 1. Implement the empty marker trait for the ID
//         impl UnitCategory for MockUnitCategory {}

//         // 2. Define the storage struct for the mock
//         #[derive(Debug, Clone, Copy, PartialEq, Default)]
//         pub struct MockUnitSetting {
//             pub generic: SimpleUnit.Length,
//         }

          
        
//         impl UnitSetting<MockUnitCategory> for MockUnitSetting {
//             fn get_kind(&self, category: MockUnitCategory) -> UnitKind {
//                 match category {
//                     MockUnitCategory::Generic => UnitKind::Simple(self.generic),
//                 }
//             }
//         }

//         // 4. Update the MockConfig to use the new Settings type
//         impl ModelConfig for MockConfig {
//             type Id = MockId;
//             type Data = MockData;
//             type Registry = MockRegistry;
//             type Category = MockUnitCategory;
//             type Settings = MockUnitSettings; // Link the storage struct here
...
//             fn create_model() -> Model<MockConfig> {
//                 let registry = <MockConfig as ModelConfig>::Registry::default();
                
//                 // Create actual settings using the Mock Category
//                 let settings = UnitSettings::<MockConfig>::new(
//                     MockUnitCategory::Generic, 
//                     MockUnitCategory::Generic
//                 ); 
