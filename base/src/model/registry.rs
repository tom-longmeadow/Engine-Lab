...
// 1. Fix the Trait Definition
pub trait ComponentRegistry<C: PropertyConfig> {
    type Id: ComponentId; 
    type Data: ComponentData<C>; // Added this to match your implementation!

    fn insert(&mut self, id: Self::Id, data: Self::Data) -> Option<Self::Data>;
    fn remove(&mut self, id: &Self::Id, kind: <Self::Data as ComponentData<C>>::Kind) -> Option<Self::Data>;
    fn get(&self, id: &Self::Id, kind: <Self::Data as ComponentData<C>>::Kind) -> Option<&Self::Data>;
    fn get_mut(&mut self, id: &Self::Id, kind: <Self::Data as ComponentData<C>>::Kind) -> Option<&mut Self::Data>;
    fn contains(&self, id: &Self::Id, kind: <Self::Data as ComponentData<C>>::Kind) -> bool;

    // Added the explicit '+ '_` lifetime bound required for stable Rust
    fn values(&self) -> impl Iterator<Item = &Self::Data> + '_;
    fn values_mut(&mut self) -> impl Iterator<Item = &mut Self::Data> + '_;
    fn values_by_kind(&self, kind: <Self::Data as ComponentData<C>>::Kind) -> impl Iterator<Item = &Self::Data> + '_;
    fn values_mut_by_kind(&mut self, kind: <Self::Data as ComponentData<C>>::Kind) -> impl Iterator<Item = &mut Self::Data> + '_;
}
...
//     // 1. We pass C here so ComponentData can resolve its property bounds!
//     type Data: ComponentData<C>;
...
//     fn values_by_kind(&self, kind: <Self::Data as ComponentData<C>>::Kind) -> impl Iterator<Item = &Self::Data> {
//         self.values().filter(move |d| d.kind() == kind)
//     }

//     /// To loop over components by kind
//     fn values_mut_by_kind(&mut self, kind: <Self::Data as ComponentData<C>>::Kind) -> impl Iterator<Item = &mut Self::Data> {
